...
use sakoora0x\BIP39\Exception\Bip39EntropyException;
use sakoora0x\BIP39\Exception\Bip39MnemonicException;
use sakoora0x\BIP39\Language\AbstractLanguage;
...
{
    /**
     * @param \sakoora0x\BIP39\Language\AbstractLanguage $wordList
     * @param int $wordCount
     * @return \sakoora0x\BIP39\Mnemonic
     * @throws \sakoora0x\BIP39\Exception\Bip39EntropyException
     * @throws \sakoora0x\BIP39\Exception\Bip39MnemonicException
     * @throws \Random\RandomException
     */
    public static function fromRandom(AbstractLanguage $wordList, int $wordCount = 12): Mnemonic
    {
        return static::fromEntropy(random_bytes(static::wordCountToBits($wordCount)[2] / 8), $wordList);
    }

    /**
     * @param string $entropy Raw binary entropy bytes
     * @param \sakoora0x\BIP39\Language\AbstractLanguage $wordList
     * @return \sakoora0x\BIP39\Mnemonic
     * @throws \sakoora0x\BIP39\Exception\Bip39EntropyException
     */
    ...
    ): Mnemonic
    {
        ...
        // Create Checksum
        $checksumBn = static::checksum($entropy, $entropyBits / 32);
